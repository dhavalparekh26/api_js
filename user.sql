...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3717671988ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api_data&table=user">`api_data`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apifile&table=users">`apifile`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api_data&table=students">`api_data`.`students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mydb&table=login">`mydb`.`login`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="52666133303f226d7a7e56742f70723a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="api_data" targettable="user">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `user` WHERE `user`.`id` = 135</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="api_data" targettable="user">
                            <div class="action_content">
